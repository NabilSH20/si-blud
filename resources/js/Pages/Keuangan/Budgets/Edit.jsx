            ...
            <div className="mx-auto max-w-3xl space-y-6">
                ...
                <div>
                    ...
                    <h2 className="text-xl font-black tracking-tight text-slate-900 sm:text-2xl">
                        Edit Pagu: {budget.account_name}
                    </h2>
                    <p className="mt-1 text-xs sm:text-sm text-slate-600 font-medium">
                        Perbarui rincian kode akun, nama rekening, tahun, atau saldo pagu anggaran.
                    </p>
                </div>
                        ...
                        <div className="grid gap-5 sm:grid-cols-2">
                            <div>
                                <label
                                    ...
                                    className="mb-1.5 block text-xs font-black uppercase tracking-wider text-slate-700"
                                >
                                    Total Pagu Anggaran <span className="text-rose-600">*</span>
                                </label>
                                <div className="relative rounded-xl shadow-2xs">
                                    ...
                                    <input
                                        ...
                                        className="block w-full rounded-xl border-2 border-slate-300 bg-white pl-12 pr-4 py-2.5 text-sm font-black text-slate-900 transition-all duration-200 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/30"
                                    />
                                </div>
                            ...
                            <div>
                                <label
                                    htmlFor="remaining_budget"
                                    className="mb-1.5 block text-xs font-black uppercase tracking-wider text-slate-700"
                                >
                                    Sisa Pagu Anggaran Saat Ini <span className="text-rose-600">*</span>
                                </label>
                                <div className="relative rounded-xl shadow-2xs">
                                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-xs font-black text-slate-500">
                                        Rp
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setData('remaining_budget', e.target.value)
                                        }
                                        className="block w-full rounded-xl border-2 border-slate-300 bg-white pl-12 pr-4 py-2.5 text-sm font-black text-emerald-700 transition-all duration-200 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/30"
                                    />
                                </div>
                                <InputError message={errors.remaining_budget} className="mt-1.5 font-bold text-rose-600" />
                            </div>
                        </div>
