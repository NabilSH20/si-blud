        ...
        <Modal show={isVisible} onClose={onClose} maxWidth="xl">
            <div className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-xl max-h-[92vh]">
                ...
                <div className="shrink-0 flex items-center justify-between border-b border-slate-100 bg-white px-6 py-4">
                    <div>
                        ...
                        <p className="mt-0.5 text-xs text-slate-500">
                            {isEdit
                                ? 'Perbarui identitas akun dan penugasan pegawai'
                                : 'Lengkapi formulir untuk membuat akun staf atau penugasan baru'}
                        </p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                            ...
                            {isDivisiRole ? (
                                <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 space-y-4">
                                    ...
                                    <p className="text-[11px] text-slate-500">
                                        Pegawai unit pemohon dapat membuat dan memantau usulan belanja kebutuhan unitnya.
                                    </p>
                                </div>
                            ) : (
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder={isEdit ? 'Kosongkan jika tidak ingin diubah' : 'Minimal 8 karakter'}
                    ...
                    <div className="shrink-0 flex items-center justify-end gap-2.5 border-t border-slate-100 bg-slate-50/50 px-6 py-4">
                        <button
                            type="button"
                            onClick={onClose}
                            disabled={processing}
