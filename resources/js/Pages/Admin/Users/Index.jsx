                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-200 font-black text-sm text-slate-700 border border-slate-300">
                                            ...
                                            <td className="px-6 py-4">
                                                {u.division ? (
                                                    <div className="flex items-center gap-2">
                                                        <span className="inline-flex rounded-md bg-slate-100 px-2.5 py-0.5 text-xs font-bold text-slate-800 border border-slate-300">
