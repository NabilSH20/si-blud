                                            ...
                                            <td className="whitespace-nowrap px-4 py-4 text-center">
                                                {badge.isPending ? (
                                                    <Link
                                                        ...
                                                        className="inline-flex items-center gap-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white px-3.5 py-1.5 text-xs font-bold shadow-2xs transition"
                                                    >
                                                        Verifikasi &rarr;
                                                    </Link>
                                                ) : (
