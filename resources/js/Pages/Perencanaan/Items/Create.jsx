            ...
            <div className="mx-auto max-w-3xl space-y-6">
                ...
                <div>
                    ...
                    <h2 className="text-xl font-black tracking-tight text-slate-900 sm:text-2xl">
                        Tambah Barang Acuan Baru
                    </h2>
                    <p className="mt-1 text-xs sm:text-sm text-slate-600 font-medium">
                        Lengkapi rincian spesifikasi dan harga acuan untuk dicantumkan pada katalog pengadaan.
                    </p>
                </div>
                    ...
                    <form onSubmit={submit} className="p-6 sm:p-8 space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Contoh: Kertas HVS Folio / F4 75gr"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Rincian merek, ukuran, ketebalan, atau ketentuan lainnya (opsional)"
                                className="block w-full rounded-xl border-2 border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-900 placeholder:text-slate-400 shadow-2xs transition-all duration-200 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/30"
                            />
                        ...
                        <div>
                            ...
                            <div className="relative rounded-xl shadow-2xs">
                                ...
                                <input
                                    ...
                                    placeholder="45000"
                                    className="block w-full rounded-xl border-2 border-slate-300 bg-white pl-12 pr-4 py-2.5 text-sm font-bold text-slate-900 transition-all duration-200 placeholder:text-slate-400 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/30"
                                />
                            </div>
