...
const menuGroups = [
    {
        ...
        items: [
            {
                name: 'Dashboard',
                href: route('perencanaan.dashboard'),
                routeName: 'perencanaan.dashboard',
                icon: (
                ...
                <div className="border-b-2 border-emerald-100/90 bg-emerald-50/70 p-4">
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <div className="mt-3 flex flex-col items-center justify-center">
                            ...
                            <p className="mt-0.5 text-[11px] font-bold text-slate-500">Perencanaan & Pengadaan</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="hidden md:flex items-center w-full max-w-xs lg:max-w-md mx-4">
                        <div className="relative w-full">
                            ...
                            <input
                                type="text"
                                disabled
                                placeholder="Cari data barang katalog atau verifikasi..."
                                ...
                                <div className="absolute right-0 mt-2 w-72 rounded-2xl border-2 border-slate-300 bg-white p-4 shadow-xl z-50">
                                    ...
                                    <div className="mt-3 space-y-2">
                                        <div className="rounded-xl bg-slate-50 p-2.5 text-xs text-slate-700 border border-slate-200">
                                            <p className="font-bold text-slate-900">Verifikasi Berjalan Lancar</p>
                                            <p className="text-[11px] text-slate-500 mt-0.5 font-medium">
                                                Daftar pengajuan masuk siap untuk diperiksa.
                                            </p>
                                        </div>
                                    </div>
                                </div>
