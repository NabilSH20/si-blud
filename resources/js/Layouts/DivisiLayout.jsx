                    ...
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-xs font-semibold text-emerald-700 truncate">
                                Unit Kerja: {user?.division?.name || 'Divisi Pemohon'} {user?.division?.division_code ? `(${user.division.division_code})` : ''}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center w-full max-w-xs lg:max-w-md mx-4">
                        <div className="relative w-full">
                            ...
                            <input
                                type="text"
                                disabled
                                placeholder="Cari nomor pengajuan barang atau katalog..."
                                ...
                                <div className="absolute right-0 mt-2 w-72 rounded-2xl border-2 border-slate-300 bg-white p-4 shadow-xl z-50">
                                    ...
                                    <div className="mt-3 space-y-2">
                                        <div className="rounded-xl bg-slate-50 p-2.5 text-xs text-slate-700 border border-slate-200">
                                            <p className="font-bold text-slate-900">Portal Divisi Siap Digunakan</p>
                                            <p className="text-[11px] text-slate-500 mt-0.5 font-medium">
                                                Silakan ajukan kebutuhan barang unit kerja Anda.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div className="hidden text-left sm:block">
                                    ...
                                    <span className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider">
                                        {user?.division?.division_code || 'DIVISI'}
                                    </span>
                                </div>
                                <svg
